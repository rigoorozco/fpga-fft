...
use work.fft2048_wide_large4;

entity fft2048_wide_large4axi is
...
architecture ar of fft2048_wide_large4axi is
...
begin
	adapter: entity axiBlockProcessorAdapter2
		generic map(frameSizeOrder=>largeOrder, wordWidth=>dataBits*2, processorDelay=>18712)
		port map (
			aclk => aclk,
			bp_ce => bp_ce,
			bp_indata => bp_indata,
	...
	fft: entity fft2048_wide_large4
