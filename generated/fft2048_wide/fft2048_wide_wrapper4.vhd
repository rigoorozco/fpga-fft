...
architecture ar of fft2048_wide_wrapper4 is
	...
	signal core_phase: unsigned(13-1 downto 0) := (others => '0');
	signal oreorderer_phase: unsigned(13-1 downto 0) := (others => '0');
	signal oreorderer_dout_phase: unsigned(13-1 downto 0) := (others => '0');
...
begin
	...
	core_phase <= din_phase - 8192 + 1 when rising_edge(clk);
