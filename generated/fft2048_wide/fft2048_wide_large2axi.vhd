...
use work.fft2048_wide_large2;

entity fft2048_wide_large2axi is
...
architecture ar of fft2048_wide_large2axi is
	...
	constant largeOrder: integer := 22;
...
begin
	adapter: entity axiBlockProcessorAdapter2
		generic map(frameSizeOrder=>largeOrder, wordWidth=>dataBits*2, processorDelay=>10496)
		port map (
			aclk => aclk,
			bp_ce => bp_ce,
			bp_indata => bp_indata,
	...
	fft: entity fft2048_wide_large2
