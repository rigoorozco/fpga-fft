...
use work.fft2048_wide_ireorderer2;
use work.fft2048_wide_oreorderer2;
...
architecture ar of fft2048_wide_large2 is
	signal din1: complex;
...
begin
	...
	ireorder: entity fft2048_wide_ireorderer2
	...
	oreorder: entity fft2048_wide_oreorderer2
		generic map(dataBits=>dataBits)
		port map(clk=>clk,
