...
architecture ar of fft1024_wide_oreorderer4 is
	...
	signal phase_fix1: unsigned(12-1 downto 0);
...
begin
	...
	phase_cnt_align: entity work.sr_unsigned
		generic map(bits=>2, len=>iif(12 >= TRANSPOSER_OREG_THRESHOLD, 3, 2))
		port map(clk=>clk, din=>rCnt, dout=>rCnt_phase_s, ce=>'1');

		phase_fix0 <= rb_dout_phase;
	phase_fix1 <= phase_fix0(10)&phase_fix0(11)&phase_fix0(9)&phase_fix0(8)&phase_fix0(7)&phase_fix0(6)&phase_fix0(5)&phase_fix0(4)&phase_fix0(3)&phase_fix0(2)&phase_fix0(0)&phase_fix0(1) when rCnt_phase_s(1)='1' else phase_fix0;
	phase_oreorder <= phase_fix1(0)&phase_fix1(1)&phase_fix1(2)&phase_fix1(3)&phase_fix1(4)&phase_fix1(5)&phase_fix1(6)&phase_fix1(7)&phase_fix1(8)&phase_fix1(9)&phase_fix1(11)&phase_fix1(10) when rCnt_phase_s(0)='1' else phase_fix1;
