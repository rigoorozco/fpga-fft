...
entity fft1024_wide_wrapper1 is
	...
	port(clk: in std_logic;
		din: in complex;
		din_phase: in unsigned(10-1 downto 0);
		dout: out complex;
...
architecture ar of fft1024_wide_wrapper1 is
	...
	signal core_phase: unsigned(10-1 downto 0) := (others => '0');
	signal oreorderer_phase: unsigned(10-1 downto 0) := (others => '0');
	signal oreorderer_dout_phase: unsigned(10-1 downto 0) := (others => '0');
...
begin
	...
	core_phase <= din_phase - 1024 + 1 when rising_edge(clk);
