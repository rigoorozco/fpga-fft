...
entity fft1024_wide_oreorderer1 is
	...
	port(clk: in std_logic;
		...
		dout: out complex;
		dout_phase: out unsigned(10-1 downto 0)
		);
end entity;
architecture ar of fft1024_wide_oreorderer1 is
	signal rb_dout_phase: unsigned(10-1 downto 0);
	signal rCnt_phase_s: unsigned(1-1 downto 0);
	signal phase_oreorder: unsigned(10-1 downto 0);
	signal phase_fix0: unsigned(10-1 downto 0);
...
begin
	...
	phase_cnt_align: entity work.sr_unsigned
		generic map(bits=>1, len=>iif(10 >= TRANSPOSER_OREG_THRESHOLD, 3, 2))
		port map(clk=>clk, din=>rCnt, dout=>rCnt_phase_s, ce=>'1');

		phase_fix0 <= rb_dout_phase;
	phase_oreorder <= phase_fix0(0)&phase_fix0(1)&phase_fix0(2)&phase_fix0(3)&phase_fix0(4)&phase_fix0(5)&phase_fix0(6)&phase_fix0(7)&phase_fix0(8)&phase_fix0(9) when rCnt_phase_s(0)='1' else phase_fix0;
